window.onload = function() {
    ...
    function resizeCanvas() {
        ...
        if (isMobileDevice()) {
            keySize = Math.min(canvas.width, canvas.height) / 6; // اندازه کلید بزرگتر برای موبایل
            staffSpacing = canvas.height / 7; // فاصله خطوط حامل برای موبایل
        } else {
            keySize = Math.min(canvas.width, canvas.height) / 10; // دو برابر کردن اندازه کلیدها برای ویندوز
            staffSpacing = canvas.height / 6.5; // دو برابر کردن فاصله خطوط حامل در حالت غیر موبایل
        }
    ...
    if (isMobileDevice()) {
        ...
        toggleNotesButton.style.marginRight = '10px';
        showLabelsButton.style.marginRight = '10px';
        toggleKeysButton.style.marginRight = '10px';
    }
